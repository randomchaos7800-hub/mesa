...
The schema file (`mesa_v1_schema.json`) is versioned. Breaking changes to the item format require a new schema version and migration script. The run output JSON includes the dataset path so results are traceable to the exact dataset version.
