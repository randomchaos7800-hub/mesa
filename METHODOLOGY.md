...
Binary YES/NO verdict from a local inference server (OpenAI-compatible API). Uses a simple prompt: "Does the AI answer correctly address the question based on the expected answer?" Using a local model keeps evaluations air-gapped and reproducible regardless of external API availability.
